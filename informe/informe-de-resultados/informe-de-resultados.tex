...
Tras la ejecución de las pruebas, se identificaron un total de 30 defectos en el sistema. Estos defectos han sido documentados y reportados de manera detallada en la sección de anexos de este documento. La atención a estos defectos es fundamental para garantizar el correcto funcionamiento y la confiabilidad del sistema en futuras evaluaciones. \textbf{ver Anexo B: Reporte de defectos})
...
\addcontentsline{toc}{subsection}{Anexo A: Detalle Pruebas Ejecutadas}
...
\addcontentsline{toc}{subsection}{Anexo B - Bugs identificados}

% Define the section but make it invisible

\includepdf[pages=-]{bugs.pdf}
\phantomsection

\addcontentsline{toc}{subsection}{Anexo C - Bugs Resueltos}

% Define the section but make it invisible

\includepdf[pages=-]{solvedBugs.pdf}
\phantomsection

\addcontentsline{toc}{subsection}{Anexo D - Reporte Análisis de Accesibilidad}

% Define the section but make it invisible

\includepdf[pages=-]{AccesibilityIssues.pdf}
\phantomsection

\clearpage
\subsection{Anexo E: Reporte de Defectos de Usabilidad}
