...
\noindent Las funcionalidades del sistema abarcan desde la creación y visualización de grafos hasta la ejecución de algoritmos de optimización y ordenamiento, integrando módulos que permiten la manipulación de matrices y estructuras de datos. Además, la interfaz gráfica brinda una interacción fluida entre el usuario y los componentes del sistema.
